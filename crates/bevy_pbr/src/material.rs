use crate::{
    render, AlphaMode, DrawMesh, EnvironmentMapLight, MeshPipeline, MeshPipelineKey, MeshUniform,
...
impl<
        M: Material,
        D: RenderCommand<Transparent3d>
            + RenderCommand<Opaque3d>
            + RenderCommand<AlphaMask3d>
            + Send
            + Sync
            + 'static,
        P: RenderCommand<Shadow> + Send + Sync + 'static,
    > Plugin for MaterialPlugin<M, D, P>
where
